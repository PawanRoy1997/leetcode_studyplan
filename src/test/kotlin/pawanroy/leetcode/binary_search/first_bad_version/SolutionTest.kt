...
class SolutionTest {
    ...
    fun testCaseTwo() {
        val actual = Solution()
        actual.badVersion = 1
        assertTrue { (actual.badVersion - 1..actual.badVersion + 1).contains(actual.firstBadVersion(8)) }
    }
    ...
    fun testCaseFailing() {
        val actual = Solution()
        actual.badVersion = 1702766719
        assertEquals(1702766720, actual.firstBadVersion(2126753390))
    }
}